...
def run_analysis(eval_mode="trimmed"):
    ...
    ax0.set_title(r"Distribution of $\hat\eta$ by treatment status")
    ax0.legend()
    fig0.tight_layout()
    ...
    ax1.set_title("Estimated treatment effect: effect of probation on next-year GPA")
    ax1.legend(loc="best")
    fig1.tight_layout()
    ...
    ax3.set_title(f"Utility function (C = {C})")
    ax3.legend()
    fig3.tight_layout()
    ...
    ax4.set_title("Distribution of Q with cutoff thresholds")
    ax4.legend()
    fig4.tight_layout()
