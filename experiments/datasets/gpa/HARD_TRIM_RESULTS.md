...
- Ran four full-sample ridge scales—0, 0.0001, 0.001, and 0.01—for all 14 outcomes.
...
| Robustness | Full-sample ridge grid | All retained |
...
nuisance estimate. No ordinary K-fold estimate is part of the active application.

| Outcome | RD | RD SE | Hard alpha | phi* |
|---|---:|---:|---:|---:|
| Fall return | -0.0830 | 0.0132 | -0.0833 | -0.6 |
| Not left voluntarily | -0.0177 | 0.0069 | -0.0165 | -0.6 |
| Subsequent GPA recorded | -0.0348 | 0.0110 | -0.0277 | -0.6 |
| Composite: no-record GPA 0.0 | 0.1384 | 0.0290 | 0.1433 | 0.6 |
| Composite: no-record GPA 0.8 | 0.1662 | 0.0245 | 0.1662 | 0.6 |
| Composite: no-record GPA 0.9 | 0.1697 | 0.0241 | 0.1691 | 0.6 |
| Composite: no-record GPA 1.1 | 0.1766 | 0.0235 | 0.1748 | 0.6 |
| Composite: no-record GPA 1.5 | 0.1905 | 0.0227 | 0.1863 | 0.6 |
| Composite: zero GPA, penalty 2 | 0.0689 | 0.0462 | 0.0860 | 0.6 |
| Composite: zero GPA, penalty 4 | -0.0006 | 0.0663 | 0.0287 | 0.6 |
| Composite: zero GPA, penalty 5 | -0.0354 | 0.0768 | -0.0000 | -0.6 |
| Composite: zero GPA, penalty 6 | -0.0702 | 0.0874 | -0.0287 | -0.6 |
| Composite: zero GPA, penalty 8 | -0.1397 | 0.1089 | -0.0860 | -0.6 |
| Observed next GPA, selected diagnostic | 0.2333 | 0.0260 | 0.2329 | 0.6 |

All displayed `phi*` values are grid-boundary solutions in the primary display and
across the full-sample ridge grid. Thus the current no-cost criterion establishes stable signs
but it does **not**
